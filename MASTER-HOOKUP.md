...
**What we built:** 64 kitchen recipes (backend modules), 23 dining room layouts (pages), 24 shared tools (utilities), and a complete inventory list (88 products).
...
These are the "kitchen recipes" — the server-side logic. All 64 files go in the Wix Velo `backend/` directory.
...
**Current status:** 3,526 tests across 96 files — all passing.
