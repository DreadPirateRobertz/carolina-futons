...
export const getDeliveryStatus = webMethod(
  ...
  async (orderId) => {
    try {
      ...
      logError('deliveryExperience:getDeliveryStatus', err);
...
export const updateDeliveryMilestone = webMethod(
  ...
  async (orderId, status, note) => {
    try {
      ...
      logError('deliveryExperience:updateMilestone', err);
...
export const submitDeliverySurvey = webMethod(
  ...
  async (data) => {
    try {
      ...
      logError('deliveryExperience:submitSurvey', err);
...
export const getSurveyStats = webMethod(
  ...
  async (daysBack = 30) => {
    try {
      ...
      logError('deliveryExperience:getSurveyStats', err);
