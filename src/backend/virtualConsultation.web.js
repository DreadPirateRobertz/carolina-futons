...
export const getDesigners = webMethod(
  ...
  async (specialty) => {
    try {
      ...
      logError('[virtualConsultation] getDesigners failed', err);
...
export const getAvailableConsultationSlots = webMethod(
  ...
  async (designerId) => {
    try {
      ...
      logError('[virtualConsultation] getAvailableConsultationSlots failed', err);
...
export const bookConsultation = webMethod(
  ...
  async (data) => {
    try {
      ...
      logError('[virtualConsultation] bookConsultation failed', err);
...
export const cancelConsultation = webMethod(
  ...
  async (bookingId) => {
    try {
      ...
      logError('[virtualConsultation] cancelConsultation failed', err);
...
export const getMyConsultations = webMethod(
  ...
  async () => {
    try {
      ...
      logError('[virtualConsultation] getMyConsultations failed', err);
...
export const uploadRoomPhoto = webMethod(
  ...
  async (bookingId, photo) => {
    try {
      ...
      logError('[virtualConsultation] uploadRoomPhoto failed', err);
...
export const getConsultationDetails = webMethod(
  ...
  async (bookingId) => {
    try {
      ...
      logError('[virtualConsultation] getConsultationDetails failed', err);
...
export const submitConsultationIntake = webMethod(
  ...
  async (consultationId, data) => {
    try {
      ...
      logError('[virtualConsultation] submitConsultationIntake failed', err);
...
export const getConsultationIntake = webMethod(
  ...
  async (consultationId) => {
    try {
      ...
      logError('[virtualConsultation] getConsultationIntake failed', err);
