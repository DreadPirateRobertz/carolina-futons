...
export const addToWishlist = webMethod(
  ...
  async (productId, name, price, opts = {}) => {
    try {
      ...
      logError('wishlistService:addToWishlist', err);
...
export const removeFromWishlist = webMethod(
  ...
  async (productId) => {
    try {
      ...
      logError('wishlistService:removeFromWishlist', err);
...
export const getWishlist = webMethod(
  ...
  async () => {
    try {
      ...
      logError('wishlistService:getWishlist', err);
...
export const getWishlistByMemberId = webMethod(
  ...
  async (memberId) => {
    try {
      ...
      logError('wishlistService:getWishlistByMemberId', err);
...
export const isOnWishlist = webMethod(
  ...
  async (productId) => {
    try {
      ...
      logError('wishlistService:isOnWishlist', err);
