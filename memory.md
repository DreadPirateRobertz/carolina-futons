...
11. **MANDATORY PR PROCESS** — NO direct pushes to main. Workflow: feature branch → push branch → `gh pr create` → review/approval → merge. Melania enforces. Applies to cfutons AND cfutons_mobile. 5 agent review mandatory with github plugins
