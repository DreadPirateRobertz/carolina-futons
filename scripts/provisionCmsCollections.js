...
const COLLECTION_MANIFEST = [
  ...
  {
    id: 'BackInStockSignups',
    displayName: 'Back In Stock Signups',
    fields: [
      field('email', 'Email', 'TEXT'),
      field('productId', 'Product ID', 'TEXT'),
      field('variantId', 'Variant ID', 'TEXT'),
      field('productName', 'Product Name', 'TEXT'),
      field('signedUpAt', 'Signed Up At', 'DATETIME'),
      field('notified', 'Notified', 'BOOLEAN'),
      field('notifiedAt', 'Notified At', 'DATETIME'),
    ],
    permissions: ADMIN_ONLY,
  },
  {
    ...
    fields: [
      ...
      field('sku', 'SKU', 'TEXT'),
      field('productName', 'Product Name', 'TEXT'),
      field('variantLabel', 'Variant Label', 'TEXT'),
      field('quantity', 'Quantity', 'NUMBER'),
      field('threshold', 'Threshold', 'NUMBER'),
      field('preOrder', 'Pre-Order', 'BOOLEAN'),
      field('lastRestocked', 'Last Restocked', 'DATETIME'),
      field('updatedAt', 'Updated At', 'DATETIME'),
    ],
    permissions: ADMIN_ONLY,
  },
  {
  ...
  },
  {
    ...
    fields: [
      field('memberId', 'Member ID', 'TEXT'),
      field('productId', 'Product ID', 'TEXT'),
      field('viewedAt', 'Viewed At', 'DATETIME'),
    ],
    permissions: { read: 'ADMIN', insert: 'MEMBER', update: 'ADMIN', remove: 'ADMIN' },
  },
  {
    ...
    fields: [
      ...
      field('saleAlerts', 'Sale Alerts', 'BOOLEAN'),
      field('backInStock', 'Back In Stock', 'BOOLEAN'),
      field('updatedAt', 'Updated At', 'DATETIME'),
    ],
    permissions: { read: 'ADMIN', insert: 'MEMBER', update: 'MEMBER', remove: 'ADMIN' },
  },
  {
    id: 'ReferralCodes',
  ...
  // ── cf-3qt Phase 4/5 content collections ───────────────────────────────────
  {
    ...
    fields: [
      ...
      field('subheadline', 'Subheadline', 'TEXT'),
      field('heroImageUrl', 'Hero Image URL', 'URL'),
      field('ctaPrimaryLabel', 'CTA Primary Label', 'TEXT'),
      field('ctaPrimaryHref', 'CTA Primary Href', 'TEXT'),
      field('ctaSecondaryLabel', 'CTA Secondary Label', 'TEXT'),
      field('ctaSecondaryHref', 'CTA Secondary Href', 'TEXT'),
      field('bodyMdx', 'Body MDX', 'RICH_TEXT'),
      field('utmDefaults', 'UTM Defaults', 'RICH_TEXT'),
      field('activeFrom', 'Active From', 'DATETIME'),
      field('activeUntil', 'Active Until', 'DATETIME'),
      field('seoDescription', 'SEO Description', 'TEXT'),
      field('ogImageUrl', 'OG Image URL', 'URL'),
    ],
    permissions: PUBLIC_READ,
  },
  {
    ...
    fields: [
      field('outlet', 'Outlet', 'TEXT'),
      field('outletLogoUrl', 'Outlet Logo URL', 'URL'),
      field('articleTitle', 'Article Title', 'TEXT'),
      field('articleUrl', 'Article URL', 'URL'),
      field('publishedDate', 'Published Date', 'DATETIME'),
  ...
  {
    id: 'PressKitAssets',
    displayName: 'Press Kit Assets',
    fields: [
      field('name', 'Name', 'TEXT'),
      field('description', 'Description', 'TEXT'),
      field('fileUrl', 'File URL', 'URL'),
      field('fileType', 'File Type', 'TEXT'),
      field('fileSizeBytes', 'File Size Bytes', 'NUMBER'),
      field('category', 'Category', 'TEXT'),
      field('sortOrder', 'Sort Order', 'NUMBER'),
    ],
    permissions: PUBLIC_READ,
  ...
  {
    id: 'ComparisonFeatures',
    displayName: 'Comparison Features',
    fields: [
      field('featureKey', 'Feature Key', 'TEXT'),
      field('label', 'Label', 'TEXT'),
      field('description', 'Description', 'TEXT'),
      field('category', 'Category', 'TEXT'),
      field('sortOrder', 'Sort Order', 'NUMBER'),
      field('values', 'Values', 'RICH_TEXT'),
    ],
    permissions: PUBLIC_READ,
  },
];
