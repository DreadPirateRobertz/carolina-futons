/**
 * cf-44qt wave — pin dataService.web.js console.error → logError migration.
 */
...
describe('cf-44qt — dataService.web.js console.error → logError migration', () => {
  ...
  it('every logError tag uses the dataService: prefix', () => {
