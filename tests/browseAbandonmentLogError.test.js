/**
 * cf-44qt wave — pin browseAbandonment.web.js console.error → logError migration.
 */
...
describe('cf-44qt — browseAbandonment.web.js console.error → logError migration', () => {
  ...
  it('every logError tag uses the browseAbandonment: prefix', () => {
