/**
 * cf-44qt wave — pin contentOrchestrator.web.js console.error → logError migration.
 */
...
describe('cf-44qt — contentOrchestrator.web.js console.error → logError migration', () => {
  ...
  it('every logError tag uses the contentOrchestrator: prefix', () => {
