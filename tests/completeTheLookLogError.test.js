/**
 * cf-44qt wave — pin completeTheLookService.web.js console.error → logError migration.
 */
...
describe('cf-44qt — completeTheLookService.web.js console.error → logError migration', () => {
  ...
  it('every logError tag uses the completeTheLookService: prefix', () => {
