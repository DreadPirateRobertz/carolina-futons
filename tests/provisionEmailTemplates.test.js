...
describe('TEMPLATE_MANIFEST', () => {
  it('contains all 23 templates (12 Step 8 + 11 additional backend templates)', () => {
    expect(TEMPLATE_MANIFEST).toHaveLength(23);
  });
...
describe('provisionTemplates', () => {
  ...
  it('creates all 23 templates when none exist', async () => {
    // List returns empty
    fetch.mockResolvedValueOnce({
      ok: true,
      json: async () => ({ templates: [] }),
