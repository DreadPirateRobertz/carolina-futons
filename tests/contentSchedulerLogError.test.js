/**
 * cf-44qt wave — pin contentScheduler.web.js console.error → logError migration.
 */
...
describe('cf-44qt — contentScheduler.web.js console.error → logError migration', () => {
  ...
  it('every logError tag uses the contentScheduler: prefix', () => {
