/**
 * cf-44qt wave — pin productReviews.web.js console.error → logError migration.
 */
...
describe('cf-44qt — productReviews.web.js console.error → logError migration', () => {
  ...
  it('every logError tag uses the productReviews: prefix', () => {
