...
|----------|-------------|------------|--------|
| `wix-marketing-backend` (Coupons) | Create/manage discount coupons | `couponsService.web.js` | Done |
| `wix-loyalty.v2` | Points, tiers, rewards program | `loyaltyService.web.js` | Done |
| `wix-ecom-backend` (Events) | Abandoned cart, checkout events | `cartRecovery.web.js` | Done |
| `wixWindow.trackEvent()` | Fire GA4 + Pixel events from code | `analyticsHelpers.web.js` | Done |
...
*Generated by Mayor 2026-02-20, updated 2026-02-22 — all Velo API modules built*
