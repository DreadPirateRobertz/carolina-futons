...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      'backend/referralService.web': path.resolve(__dirname, 'src/backend/referralService.web.js'),
      ...
      'backend/contactImport.web': path.resolve(__dirname, 'src/backend/contactImport.web.js'),
      ...
      'public/salePageHelpers.js': path.resolve(__dirname, 'src/public/salePageHelpers.js'),
      'public/salePageHelpers': path.resolve(__dirname, 'src/public/salePageHelpers.js'),
      'public/pageSeo.js': path.resolve(__dirname, 'src/public/pageSeo.js'),
      'public/pageSeo': path.resolve(__dirname, 'src/public/pageSeo.js'),
